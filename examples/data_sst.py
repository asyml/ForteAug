...
class ClassificationDataProcessor(Dataset):
    """
    Encoding sentences
    """

    def __init__(self, bert_tokenizer, texts, labels, max_seq_len=50):
        super(ClassificationDataProcessor, self).__init__()
    ...
    def get_input(self, texts, labels):
        ...
        # tokenizer
        tokens_seq = list(
            map(self.bert_tokenizer.tokenize, texts)
